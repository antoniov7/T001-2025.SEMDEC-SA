...
| Tipo | Descrição |
| :-- | :-- |
| 💡 **Correções e melhorias** | Corrija erros de digitação, formatação ou melhore explicações existentes. |
| 📘 **Adição de conteúdo** | Adicione novos aprendizados, desafios resolvidos ou materiais de apoio. |
| 🚀 **Criação de projetos** | Inclua pequenos projetos individuais ou em grupo relacionados ao curso. |
| 💬 **Sugestões e feedbacks** | Use as *Issues* do GitHub para sugerir melhorias ou novas ideias. |
